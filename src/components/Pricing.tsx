                    ...
                    <div
                        ...
                        <div className="relative flex flex-col p-8 bg-white">
                            <div className="flex-1">
                                ...
                                <p className="mt-6 text-gray-500">The essentials to provide your best work for
                                    clients.</p>
                                ...
                                <ul role="list" className="pt-6 mt-6 space-y-6 border-t">
                                    ...
                                    <li className="flex">
                                        <div className="inline-flex items-center w-6 h-6 bg-indigo-600 rounded-xl">
                                            <svg className="flex-shrink-0 w-4 h-4 mx-auto text-white"
                            ...
                            <div className="mt-6 rounded-lg">
                                <a href="#" type="highlight"
                                   className="w-full items-center block px-10 py-3.5 text-base font-medium text-center text-indigo-600 transition duration-500 ease-in-out transform border-2 border-white shadow-md rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 bg-white"> Get
                                    Started </a>
                            </div>
                        </div>
                        <div className="relative flex flex-col p-8 bg-indigo-600 rounded-2xl">
                            <div className="relative flex-1">
                                ...
                                <p className="mt-6 text-white text-solitud">A plan that scales with your rapidly growing
                                    business.</p>
                                ...
                                <ul role="list" className="pt-6 mt-6 space-y-6 border-t">
                                    ...
                                    <li className="flex">
                                        <div className="inline-flex items-center w-6 h-6 bg-white rounded-xl">
                                            <svg className="flex-shrink-0 w-4 h-4 mx-auto text-neutral-600"
                                                 xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                 stroke="currentColor" aria-hidden="true">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                      d="M5 13l4 4L19 7"></path>
                        ...
                        <div className="relative flex flex-col p-8 bg-white">
                            <div className="flex-1">
                                ...
                                <p className="mt-6 text-gray-500">Dedicated support and infrastructure for your
                                    company.</p>
